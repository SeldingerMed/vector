...
| N8 — sellable surface | external | The hosted product is developed outside this public harness. Pricing, tenancy, and BAA posture are commercial decisions, gated behind N1 evidence per next.md's own ordering |
